...
public:
    Bidijkstra(int n, Adj adj, Adj cost)
        : /*n_(n),*/ adj_(adj), cost_(cost), distance_(2, vector<Len>(n, INFINITY)), previous_(2, vector<int>(n, -1)), visited_(n) 
    { workset_.reserve(n); }
    ...
    void relax(int side, int s, int d){
