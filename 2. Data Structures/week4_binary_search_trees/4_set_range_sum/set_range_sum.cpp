  ...
  for (int i = 0; i < n; i++) {
    ...
    switch (type) {
      case '+' : {
        int x;
        scanf("%d", &x);
        //cout << "add("<<(x + last_sum_result) % MODULO<<")\n";
        insert((x + last_sum_result) % MODULO);
      } break;
      case '-' : {
        int x;
        scanf("%d", &x);
        //cout << "del("<<(x + last_sum_result) % MODULO<<")\n";
        erase((x + last_sum_result) % MODULO);
      } break;            
      case '?' : {
        int x;
        scanf("%d", &x);
        //cout << "find("<<(x + last_sum_result) % MODULO<<")\n";
      ...
      case 's' : {
        ...
        //cout << "sum("<<(l + last_sum_result) % MODULO<<", "<<(r + last_sum_result) % MODULO<<")\n";
        printf("%lld\n", res);
